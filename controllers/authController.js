...
// Verificar si el usuario y contraseña existen o coinciden
...
// Revisar si el usuario está autenciado o no
...
// Envia el correo con el token para actualizar el password
...
exports.reestablecerPassword = async(req, res) => {
    ...
    // Si hay algun error entonces no muestres el formulario y avisa al usuario
    if(!usuario){
...
exports.guardarPassword = async(req, res) => {
    ...
    // Todo bien, guardar el nuevo password en la base de datos
    await usuario.save();
